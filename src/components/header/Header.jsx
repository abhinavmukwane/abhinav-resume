        ...
        <nav className="ms-navigation">
            <div>
                <ul>
                    ...
                    <li><a href="javascript:void(0)" className="navs-link nav-experience" data-section="ms-experience-section"><i className="fa fa-briefcase"></i><span>Experience</span></a><span className="noty"><span>Edu. & Exp.</span></span></li>
